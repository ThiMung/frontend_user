...
const RegisterPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Calling the attendee registration API exposed by Laravel routes/api.php
      const response = await api.post('api/attendee/register', formData);
      
      alert('Registration successful! Welcome to EventHub.');
      ...
      if (err.response && err.response.status === 422) {
        // Display validation errors from Laravel (EMS-30)
      ...
      <div className="bg-[#FAF4F4] p-8 md:p-10 rounded-[2rem] shadow-sm border border-gray-100 w-full max-w-[480px]">
        ...
        <div className="flex flex-col items-center mb-10">
          ...
          <p className="text-gray-400 text-sm text-center mt-3 leading-relaxed">
            Create your account to explore and join exclusive community events.
          </p>
        </div>
